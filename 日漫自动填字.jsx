...
//================判断系统================
var systemOS, mainMangaPath, logInfo;

//在Windows下，路径也必须都用“/”
if ($.os.search(/windows/i) != -1) {
    systemOS = "windows";
    mainMangaPath = "C:/Users/" + userName + "/Dropbox/Data/MangaProcess";
} else {
    systemOS = "macintosh";
    mainMangaPath = "/Users/" + userName + "/Dropbox/Data/MangaProcess";
}
...
//================主体程序================
//================如果主文件夹存在================
if (mainMangaFolder != null) {
    var mainFileList = mainMangaFolder.getFiles();
    ...
    if (mainFolderList.length === 0) {
        ...
        var folderPath = mainMangaPath + '/' + currentFolderName;
        //================填字文档================
        text_path = mainMangaPath + '/' + currentFolderName + '-7标记.txt';
        var myTextFile = new File(text_path);
        if (myTextFile.exists) {
